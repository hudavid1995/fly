...
use WVS\coavBundle\Entity\Flight;
...
class FlightController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $flights = $em->getRepository('WVScoavBundle:Flight')->findAll();
    ...
    {
        $flight = new Flight();
        $form = $this->createForm('WVS\coavBundle\Form\FlightType', $flight);
    ...
    {
        $deleteForm = $this->createDeleteForm($flight);
        $editForm = $this->createForm('WVS\coavBundle\Form\FlightType', $flight);
