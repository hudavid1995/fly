...
use WVS\coavBundle\Entity\PlaneModel;
...
class PlaneModelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $planeModels = $em->getRepository('WVScoavBundle:PlaneModel')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('WVS\coavBundle\Form\PlaneModelType', $planeModel);
    ...
    {
        $deleteForm = $this->createDeleteForm($planeModel);
        $editForm = $this->createForm('WVS\coavBundle\Form\PlaneModelType', $planeModel);
